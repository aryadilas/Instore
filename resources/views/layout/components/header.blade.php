...
<html lang="id">
	<head>
		...
		<meta http-equiv="Content-Type" content="Text/html; charset=utf-8">
			<title>INstore - Buy trendy fashion</title>
	...
	<body class="flex flex-col min-h-screen justify-between gap-4">
                ...
                <div class="flex gap-4 items-center sm:flex-com">
                    ...
                    <nav id="nav" class="hidden sm:flex gap-5 items-center sm:static absolute z-20 left-0 top-10 bg-white w-full p-4">
                        <ul class="gap-4 flex flex-col sm:flex-row sm:items-center sm:gap-10 sm:justify-end sm:w-full">
                            ...
                            <li class="hover:text-[#AC3B61] {{ request()->is('/') ? 'text-[#AC3B61]' : '' }}"><a href="/" class="onpage">Home</a></li>
                            <li class="hover:text-[#AC3B61]"><a href="/katalog">Katalog</a></li>
                            <li class="hover:text-[#AC3B61]"><a href="/pembayaran">Pembayaran</a></li>
                            <li class="hover:text-[#AC3B61]"><a href='/login'>Login</a></li>

                        </ul>
                    </nav>

                    <div class="mr-2">
                        <a href="/keranjang" class="">
